...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/home/uri/opt/android-ndk-r5b//platforms/android-3/arch-arm --soname-prefix=/data/data/frankandrobot.glwallpapervideodemo.com/lib/ --enable-shared --disable-symver --enable-small --optimization-flags=-O2 --enable-version3 --enable-nonfree --disable-doc --disable-ffserver --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
...
SONAME_PREFIX=/data/data/frankandrobot.glwallpapervideodemo.com/lib/
SRC_PATH="/home/uri/projects/GLWallpaperVideoDemo/jni/ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/home/uri/projects/GLWallpaperVideoDemo/jni/ffmpeg-android/ffmpeg
BUILD_ROOT="/home/uri/projects/GLWallpaperVideoDemo/jni/ffmpeg-android/ffmpeg"
...
CPPFLAGS= --sysroot=/home/uri/opt/android-ndk-r5b//platforms/android-3/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
